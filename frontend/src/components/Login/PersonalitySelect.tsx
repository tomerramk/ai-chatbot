  ...
  return (
    <div className="grid">
      ...
      <Select.Root value={personality} onValueChange={setPersonality}>
        <Select.Trigger className="inline-flex items-center justify-between p-2 border-[1.5px] bg-teal-50 border-teal-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
